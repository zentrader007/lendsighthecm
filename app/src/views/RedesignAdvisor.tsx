    ...
    <div className="app v2">
      ...
      <aside className={`drawer${drawerOpen ? ' open' : ''}`} aria-hidden={!drawerOpen}>
        ...
        <Section title="Closing Costs">
          ...
          <NumberField label="Origination Fee" value={result.calculatedOriginationFee} onChange={(v) => setCost('originationOverride', v)} suffix="$" min={0} tip="Auto-calculated by the HUD tier formula: 2% of the first $200k of the max claim amount + 1% above, floored at $2,500 and capped at $6,000 (so it is not a flat $6,000 on lower-value homes). Type an exact figure to override, or set to 0 to recalculate." />
