    ...
    <div className="app v2">
                ...
                {hasLien ? (
                  <>
                    <p className="freed-cashflow">
                      ...
                      <span className="freed-value">{usd(cmp.monthlyMortgagePayment)}/mo</span>
                      <span className="freed-sep">·</span>
      ...
      <aside className={`drawer${drawerOpen ? ' open' : ''}`} aria-hidden={!drawerOpen}>
        ...
        <Section title="Closing Costs">
          ...
          <NumberField label="Origination Adjustment" value={inp.costs.originationDiscount} onChange={(v) => setCost('originationDiscount', v)} suffix="$" min={0} tip="An additional charge added to the origination fee above (e.g. a lender surcharge)." />
