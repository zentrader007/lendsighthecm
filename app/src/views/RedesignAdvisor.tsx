    ...
    <div className="app v2">
      ...
      <aside className={`drawer${drawerOpen ? ' open' : ''}`} aria-hidden={!drawerOpen}>
        ...
        <Section title="Limits & Future PLF">
          ...
          <NumberField label="Future 10yr CMT" value={inp.futureCMT10yr} onChange={(v) => set('futureCMT10yr', v)} asPercent min={0} max={20} disabled={inp.futureCMTMode !== 'Assumed'} tip="The 10-year CMT rate assumed for future-year PLF projections. Disabled when a historical source is selected." />
          <SelectField label="Future CMT Source" value={inp.futureCMTMode} options={RATE_MODES} onChange={(v) => set('futureCMTMode', v)} tip="Use an assumed future rate, or historical 10-year CMT rates, for the future-PLF columns." />
